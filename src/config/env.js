...
const env = {
  ...
  billingProvider: cleanEnv(process.env.BILLING_PROVIDER) || 'manual',
  stripeSecretKey: cleanEnv(process.env.STRIPE_SECRET_KEY),
  stripeWebhookSecret: cleanEnv(process.env.STRIPE_WEBHOOK_SECRET),
  paypalClientId: cleanEnv(process.env.PAYPAL_CLIENT_ID),
  paypalClientSecret: cleanEnv(process.env.PAYPAL_CLIENT_SECRET),
  flutterwavePublicKey: cleanEnv(process.env.FLUTTERWAVE_PUBLIC_KEY),
  flutterwaveSecretKey: cleanEnv(process.env.FLUTTERWAVE_SECRET_KEY),
  ...
  googleBusinessCallbackUrl: cleanEnv(process.env.GOOGLE_BUSINESS_CALLBACK_URL) || `${process.env.APP_URL || 'http://localhost:3200'}/social/google-business/callback`,
  ...
  linkedinCallbackUrl: process.env.LINKEDIN_CALLBACK_URL || `${process.env.APP_URL || 'http://localhost:3200'}/social/linkedin/callback`,
  ...
  pinterestCallbackUrl: cleanEnv(process.env.PINTEREST_CALLBACK_URL) || `${process.env.APP_URL || 'http://localhost:3200'}/social/pinterest/callback`,
  ...
  xCallbackUrl: cleanEnv(process.env.X_CALLBACK_URL || process.env.TWITTER_CALLBACK_URL) || `${process.env.APP_URL || 'http://localhost:3200'}/social/x/callback`,
  ...
  threadsCallbackUrl: cleanEnv(process.env.THREADS_CALLBACK_URL) || `${process.env.APP_URL || 'http://localhost:3200'}/social/threads/callback`,
  ...
  youtubeCallbackUrl: cleanEnv(process.env.YOUTUBE_CALLBACK_URL) || `${process.env.APP_URL || 'http://localhost:3200'}/social/youtube/callback`,
  ...
  tiktokCallbackUrl: cleanEnv(process.env.TIKTOK_CALLBACK_URL) || `${process.env.APP_URL || 'http://localhost:3200'}/social/tiktok/callback`,
  tiktokScopes: process.env.TIKTOK_SCOPES || 'user.info.basic,video.upload,video.publish',
  facebookAppId: process.env.FACEBOOK_APP_ID || '',
  facebookAppSecret: process.env.FACEBOOK_APP_SECRET || '',
  facebookCallbackUrl: process.env.FACEBOOK_CALLBACK_URL || `${process.env.APP_URL || 'http://localhost:3200'}/social/facebook/callback`,
