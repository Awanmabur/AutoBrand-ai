...
const avatarProfileSchema = new mongoose.Schema(
  {
    ...
    trainingMedia: [{ type: mongoose.Schema.Types.ObjectId, ref: 'Media' }],
    ...
    defaultScript: { type: String, default: '' },
    lastVideoJob: { type: mongoose.Schema.Types.ObjectId, ref: 'AiVideoJob' },
